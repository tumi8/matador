...
Script for the controller to tear down the iptables firewall on the phones
...
def main():
    ...
    and exectuted the firewall_stop_complete function
    '''
    if len(sys.argv) < 1:
    ...
    smartphone_control.firewall_stop_complete()
